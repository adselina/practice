...
var FetchStaff = /** @class */ (function (_super) {
    ...
    function FetchStaff(props) {
        ...
        _this.state = { stafflist: [], loading: true };
        fetch('api/staff')
            .then(function (response) { return response.json(); })
            .then(function (data) {
            _this.setState({ stafflist: data, loading: false });
        });
        ...
        return React.createElement("table", { className: 'table' },
            React.createElement("thead", null,
                React.createElement("tr", null,
                    ...
                    React.createElement("th", null, "\u0414\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u044C"),
                    React.createElement("th", null, "\u0414\u0430\u0442\u0430 \u0440\u043E\u0436\u0434\u0435\u043D\u0438\u044F"),
                    React.createElement("th", null, "\u0414\u0430\u0442\u0430 \u043D\u0430\u0439\u043C\u0430"),
            ...
            React.createElement("tbody", null, stf.map(function (e) {
                return React.createElement("tr", { key: e.id },
                    ...
                    React.createElement("td", null, e.dateOfBirth),
                    React.createElement("td", null, e.dateOfHire),
